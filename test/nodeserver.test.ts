...
describe('General protocol', () => {
    let complete_protocol = [
        ['get', '/_supported_protocols_', options.exact({
            supported: types.array(types.string),
            required: types.array(types.string)
        })],
        ['get', '/log', types.array({
            component: types.string,
            level: options.alternative(["info", "security", "warning", "error", "critical"]),
        ...
        ['get', '/properties', types.array({
            id: types.string,
            display: options.optional(options.match({
            ...
            type: options.alternative([
                types.string,
                types.integer, types.boolean
            ]),
            value: options.alternative([types.string, types.integer, types.boolean])
        })],
        ['post', '/properties', null],
        ['get', '/user_privileges', types.array({
            privilege: types.string,
            description: types.string,
            internal: types.boolean
        })],
        ['get', '/users', types.array({
            username: types.string,
        ...
        ['get', '/project_roles', types.array({
            role: types.string,
            description: types.string,
            internal: types.boolean
        })],
        ['get', '/projects', types.array({
            project_name: types.string,
            users: types.array({
                username: types.string,
                access_level: types.string
